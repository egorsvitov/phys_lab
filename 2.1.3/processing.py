...
pt.set_xlabel('$n$')
pt.set_ylabel('$\\nu$')
pt.errorbar(n_n, v1_n, fmt='o', yerr=0.1, label='Температура ??? С')
pt.plot(mnk_x, mnk_y1)
pt.errorbar(n_n, v2_n, fmt='o', yerr=0.1, label='Температура ??? С')
pt.plot(mnk_x, mnk_y2)
pt.errorbar(n_n, v3_n, fmt='o', yerr=0.1, label='Температура ??? С')
pt.plot(mnk_x, mnk_y3)
pt.errorbar(n_n, v4_n, fmt='o', yerr=0.1, label='Температура ??? С')
pt.plot(mnk_x, mnk_y4)
pt.minorticks_on()
pt.grid(which='major')
